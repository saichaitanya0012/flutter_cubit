...
class _ShopDetailScreenState extends State<ShopDetailScreen> {
  final TextEditingController totalCrateEditingController =
      TextEditingController();
  final TextEditingController totalAmountEditingController =
      TextEditingController();
  final TextEditingController crateReceivedEditingController =
      TextEditingController();
                ...
                onTap: () {
                  ...
                  if (_formKey.currentState!.validate()) {
                    if (((int.parse((totalCrateEditingController.text.isEmpty)
                            ...
                            num.parse(widget.shopData?["current_balance"] ?? "0")) >=
                      ...
                      CustomSnackBar().snackbarMessage(message: "Please check the price");
                    }
                  }
                },
                child: Container(
            ...
            children: [
              ListView(
                children: [
                  Container(
                    height: 28.h,
                    child: (widget.shopData?["image_url"] ?? "").toString().isNotEmpty
                        ? CachedNetworkImage(
